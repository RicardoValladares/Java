...
public class formulario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        /*manejo de escepciones y errores*/
	try{
            Double n1 = Double.parseDouble(this.n1.getText());
            Double n2 = Double.parseDouble(this.n2.getText());
            /*invocamos la clase*/
            clase sumar = new clase();
            /*usamos una funcion set de la clase sumar*/
            sumar.setsumar(n1,n2);
            /*usamos una funcion get de la clase sumar*/
            resultado.setText(String.valueOf(sumar.getsumar()));
	}
	catch(Exception a){	
            JOptionPane.showMessageDialog(this,"Introduzca numeros","ERROR",2);
	}
