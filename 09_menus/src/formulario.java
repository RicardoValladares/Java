...
public class formulario extends javax.swing.JFrame {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        JOptionPane.showMessageDialog(this,"Creado por: R_A_V_R_");
    ...
    public void limpiar(){
	this.n1.setText(String.valueOf(""));
        this.n2.setText(String.valueOf(""));
        this.resultado.setText(String.valueOf(""));
    }
    public void sumar(){
	try{
            ...
            this.resultado.setText(String.valueOf(df.format(suma)));
